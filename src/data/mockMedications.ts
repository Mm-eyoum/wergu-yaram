 ...
 * produit par `scripts/parseLme.ts`). Fidèle à la source : DCI, présentations
 * (forme + dosage + niveaux de soins), groupe pharmaco-thérapeutique, AWaRe,
 * métadonnées réglementaires. Aucun contenu clinique n'y est inventé.
 *
...
export const medications: Medication[] = (generated as Medication[]).map((m) => {
