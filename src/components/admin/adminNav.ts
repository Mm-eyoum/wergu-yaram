...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { key: "comments", label: "Commentaires", to: "/admin/comments", icon: MessageSquare, permission: "comments.moderate", ready: false },
  { key: "users", label: "Utilisateurs", to: "/admin/users", icon: Users, permission: "users.manage", ready: true },
  { key: "menus", label: "Menus", to: "/admin/menus", icon: MenuIcon, permission: "menus.manage", ready: false },
  { key: "redirects", label: "Redirections", to: "/admin/redirects", icon: CornerUpRight, permission: "redirects.manage", ready: false },
  { key: "emails", label: "Emails", to: "/admin/emails", icon: Mail, permission: "emails.manage", ready: false },
  { key: "appearance", label: "Apparence", to: "/admin/appearance", icon: Palette, permission: "appearance.manage", ready: false },
  { key: "settings", label: "Paramètres", to: "/admin/settings", icon: Settings, permission: "settings.update", ready: false },
  { key: "audit", label: "Journal d'audit", to: "/admin/audit-log", icon: ScrollText, permission: "audit.read", ready: false },
];
